...
CMSSW_BASE:=/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/FF_derivation/AutomaticSubmission/2017/mt/CMSSW_8_0_25
...
export CCACHE_BASEDIR:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_25
endif
...
LOCALTOP:=/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/FF_derivation/AutomaticSubmission/2017/mt/CMSSW_8_0_25
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/FF_derivation/AutomaticSubmission/2017/mt/CMSSW_8_0_25
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_25
SCRAM_INTlog:=logs
...
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_8_0_25:slc6_amd64_gcc530:V2_2_9_pre11:SRT_
SCRAM_CONFIGCHKSUM:=V05-05-11
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_PROJECTVERSION:=CMSSW_8_0_25
