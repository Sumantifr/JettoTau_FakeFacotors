...
#define JET0   67108864 // change it to 67108864 if you want to use it
#define JET1  134217728

#define RAT0  0//1048576  
#define RAT1  0//2097152
#define RAT2  0//67108864 
...
//Output directories
const TString path_presel        = "/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/"+analysis+"/preselection/"+s_chan[CHAN]+"/";
...
#endif
#if(EMB == 0)
const TString path_img           = "ViennaTool/Images_NonEMB/"; //ToDo : add path img emb and non_emb
#endif
...
//Input directories
const TString indir = "/mnt/hephy/cms/janik.andrejkovic/MSSMtuples/2017/";
...
//Number of pre bjets = n jets with pt>20 and eta< 2.4
const Int_t Njetpt20eta2p4_cuts_Wjets[] = {0,1};
const Int_t Njetpt20eta2p4_cuts_DY[] = {0,1};
const Int_t Njetpt20eta2p4_cuts_TT_SR[] = {0};
const Int_t Njetpt20eta2p4_cuts_TT_CR[] = {0};
const Int_t Njetpt20eta2p4_cuts_QCD[] = {0,1};

const Int_t N_jpt20eta2p4_Wjets = sizeof(Njetpt20eta2p4_cuts_Wjets)/sizeof(Int_t);
const Int_t N_jpt20eta2p4_DY    = sizeof(Njetpt20eta2p4_cuts_DY)/sizeof(Int_t);
const Int_t N_jpt20eta2p4_TT_SR = sizeof(Njetpt20eta2p4_cuts_TT_SR)/sizeof(Int_t);
const Int_t N_jpt20eta2p4_TT_CR = sizeof(Njetpt20eta2p4_cuts_TT_CR)/sizeof(Int_t);
...
/*
const Double_t pTratio_cuts_Wjets[] = {0};
const Double_t pTratio_cuts_DY[]    = {0};
const Double_t pTratio_cuts_TT_SR[] = {0};
const Double_t pTratio_cuts_TT_CR[] = {0};
const Double_t pTratio_cuts_QCD[]   = {0};
*/
...
const Int_t nbins_pt=30;     const Double_t hist_min_pt=20.;    const Double_t hist_max_pt=300.;
