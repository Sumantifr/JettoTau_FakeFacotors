...
if [ -d "/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection" ]; then
    if [ ! -d "/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/mt" ]; then
        mkdir -p /mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/mt
    fi
    if [ ! -d "/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/et" ]; then
        mkdir -p /mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/et
    fi
    if [ ! -d "/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/tt" ]; then
        mkdir -p /mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/tt
    fi
else
    mkdir -p /mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/mt
    mkdir -p /mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/$fftype/preselection/et
