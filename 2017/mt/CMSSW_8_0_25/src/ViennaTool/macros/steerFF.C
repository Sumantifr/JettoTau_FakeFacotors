...
//  pre_sub_wj.push_back(preselection_DY); pre_sub_wj.push_back(preselection_TT); pre_sub_wj.push_back(preselection_VV);
  pre_sub_wj.push_back(preselection_DY); pre_sub_wj.push_back(preselection_TT_T); pre_sub_wj.push_back(preselection_TT_J); pre_sub_wj.push_back(preselection_TT_L); pre_sub_wj.push_back(preselection_VV_T); pre_sub_wj.push_back(preselection_VV_J); pre_sub_wj.push_back(preselection_VV_L);
  pre_sub_tt.push_back(preselection_DY); pre_sub_tt.push_back(preselection_Wjets); pre_sub_tt.push_back(preselection_TT_T); pre_sub_tt.push_back(preselection_TT_L); pre_sub_tt.push_back(preselection_VV_T);   pre_sub_tt.push_back(preselection_VV_J); pre_sub_tt.push_back(preselection_VV_L);
  pre_sub_qcd.push_back(preselection_DY); pre_sub_qcd.push_back(preselection_Wjets); pre_sub_qcd.push_back(preselection_TT_T); pre_sub_qcd.push_back(preselection_TT_J); pre_sub_qcd.push_back(preselection_TT_L); pre_sub_qcd.push_back(preselection_VV_T); pre_sub_qcd.push_back(preselection_VV_J); pre_sub_qcd.push_back(preselection_VV_L);
