...
const TString analysis ="16_1_2017_v7";
const TString output_folder ="/mnt/hephy/cms/suman.chatterjee/FakeFactor_MSSM/auto-fakefactors/16_1_2017_v7/";
...
const TString DC_folder     = ""; //obsolete
///////////////////////////////////////////////////
const TString user="suman.chatterjee";    
const Double_t luminosity=41.5; //according to GOLDEN JSON see https://twiki.cern.ch/twiki/bin/view/CMS/TWikiLUM    
...
const int useRatioBinning=0; //Produce CR plots in different ranges of pT ratio
///////////////////////////////////////////////////
//No need to change
...
//////////////////////////////////////////////////
/// Correction on QCD for W+jets DR ////
const double QCDcor = 1.1;                                                                                                                                                                                  
//////////////////////////////////////////
