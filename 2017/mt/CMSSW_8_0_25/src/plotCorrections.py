...
if __name__ == '__main__':
     ...
     parser.add_argument('--embedding', dest = 'embedding', help='EMB: 0,1', type=int, metavar = 'TAG', required = True)
     parser.add_argument('--year', dest = 'year', help='Year: 2016,2017,2018', type=str, metavar = 'TAG', required = True)
     ...
     files_mt = [
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_QCD_MCsum_noGen_nonclosure.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0,2],'X':[23,120], 'Label':'Muon p_{T} (GeV)','file':'corr_QCD_nonclosure','plotLabel1':'#mu^{}#tau_{h} QCD multijet','plotLabel2':'Nonclosure correction'},
              ...
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_QCD_MCsum_noGen_OSSScorr.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.2,2.1],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS','plotLabel1':'#mu^{}#tau_{h} QCD multijet','plotLabel2':'opposite/same charge correction'},
              ...
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_Wjets_MC_noGen_mtcorr.root','data':'mt_corr', 'graph':'mt_corr_Wjets','CMS':'Simulation '+preliminary,'Y':[0.5,1.5],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_W_mt','plotLabel1':'#mu^{}#tau_{h} W+jets','plotLabel2':'DR-SR correction'},
              {'name': 'ViennaTool/fakefactor/data_mt/FF_corr_Wjets_MCsum_noGen_nonclosure.root','data':'nonclosure_fit', 'graph':'nonclosure_Wjets','CMS':preliminary,'Y':[0.5,1.5],'X':[23,120], 'Label':'Muon p_{T} (GeV)','file':'corr_W_nonclosure','plotLabel1':'#mu^{}#tau_{h} W+jets','plotLabel2':'Nonclosure correction'},
     ...
     files_tt = [
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_QCD_nonclosure','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'Nonclosure correction'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_OSSScorr.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'OS/SS correction'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_lepPt.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[40,120], 'Label':'p_{T} (GeV)','file':'corr_QCD_nonclosure_pt','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'p_{T} correction'},
     ...
     if(args.do_njetbinning == 1):
          files_tt.extend([
               {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_0jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.4,2.5],'X':[0,450], 'Label':'m_{vis} (GeV)','file':'corr_QCD_nonclosure_0jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'Nonclosure correction, 0jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_1jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.4,2.5],'X':[0,450], 'Label':'m_{vis} (GeV)','file':'corr_QCD_nonclosure_1jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'Nonclosure correction, #geq 1jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_lepPt_0jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[40,120], 'Label':'p_{T} (GeV)','file':'corr_QCD_nonclosure_pt_0jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'p_{T} correction, 0jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_nonclosure_lepPt_1jet.root','data':'nonclosure_fit', 'graph':'nonclosure_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[40,120], 'Label':'p_{T} (GeV)','file':'corr_QCD_nonclosure_pt_1jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'p_{T} correction, #geq 1jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_OSSScorr_0jet.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS_0jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'OS/SS correction, 0jet'},
              {'name': 'ViennaTool/fakefactor/data_tt/FF_corr_QCD_MCsum_noGen_OSSScorr_1jet.root','data':'OSSS_corr', 'graph':'OSSS_corr_QCD','CMS':preliminary,'Y':[0.5,1.5],'X':[0,250], 'Label':'m_{vis} (GeV)','file':'corr_QCD_OSSS_1jet','plotLabel1':'#tau_{h}#tau_{h} QCD multijet','plotLabel2':'OS/SS correction, #geq 1jet'},
     ...
     for el in files:
	  ...
	  if(args.year == "2016"):
          	infoRight = R.TLatex( 0.68, 0.915, "35.87 fb^{-1} (13 TeV)" )
	  if(args.year == "2017"):
		infoRight = R.TLatex( 0.68, 0.915, "41.50 fb^{-1} (13 TeV)" )
	  if(args.year == "2018"):
	  ...
	  if(args.embedding == 0):
		...
		canvas.SaveAs('ViennaTool/Images_NonEMB/data_{0}/'.format(channel)  + el['file'] + '_'+channel+'.C' )
